# H-301 EWMAC Fast Trend Baseline

## Nature
This card is a single-signal baseline backtest hypothesis.

It tests whether the BTCUSDT daily EWMAC(8,32) fast trend forecast has standalone value after volatility targeting and a simple trading cost model.

## Signal
- Name: `SIG_TREND_FAST`
- Definition: `ewmac_forecast(price, fast_span=8, slow_span=32, normalization="expanding")`
...
`exports/ablation-h301-ewmac-fast-trend-2026-05-25.md`
